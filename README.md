...
| `sketch` | Virgil (рукописный шрифт), грубые линии, штриховка — классический Excalidraw |
| `clean` | Гладкие линии, скруглённые углы — современный и аккуратный |
| `bold` | Толстые линии, акцент — для презентаций |
| `minimal` | Тонкие линии, минимализм — для документации |
| `blueprint` | Моноширинный шрифт, cross-hatch — технический чертёж |
| `whiteboard` | Virgil, hand-drawn — как нарисовано на доске |
